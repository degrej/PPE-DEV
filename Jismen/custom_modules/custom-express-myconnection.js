;(function() {
    ...
    var _mysql;
    var _dbConfig;
    var _connection; // This is used as a singleton in a single connection strategy
     ...
     */
     function handleDisconnect() {
        ...
        _connection.connect(function (err) {
            ...
            console.log("Connection to MySQL: OK!   ----- Host: %s:%s ; Database: %s",  _connection.config.host, _connection.config.port, _connection.config.database);
            console.log("\nThe database is ready for operation! LET'S START!");
        });
